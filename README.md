...
a.	Sube el archivo AluraStoreLatam.ipynb a tu Google Drive.

b.	Sube los 4 archivos CSV (tienda_1.csv, etc.) al almacenamiento de sesión del notebook.

c.	Ejecuta todas las celdas secuencialmente.
